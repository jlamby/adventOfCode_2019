...
def tick(line, setting) :
    global amplifierSetting, xxx, previousResult
    ...
    amplifierSetting = setting[0]
    previousResult = exec(memory, currentIdx)

    xxx = True   
    amplifierSetting = setting[1]
    previousResult = exec(memory, currentIdx)

    xxx = True   
    amplifierSetting = setting[2]
    previousResult = exec(memory, currentIdx)

    xxx = True   
    amplifierSetting = setting[3]
    previousResult = exec(memory, currentIdx)

    xxx = True   
    amplifierSetting = setting[4]
    previousResult = exec(memory, currentIdx)
...
'''
for b1 in range(5,10) :
    for b2 in range(5,10) :
        for b3 in range(5,10) :
            for b4 in range(5,10) :
                for b5 in range(5,10) :
...
for setting in filteredSettings :
    ...
    previousResult = tick(lineWithNoDiff, setting)
